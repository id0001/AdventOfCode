...
public class Challenge08(IInputReader inputReader)
{
    ...
    private Point2 GetLeftAntinode(Point2 a, Point2 b) => new(a.X + (a.X - b.X), a.Y + (a.Y - b.Y));
    private Point2 GetRightAntinode(Point2 a, Point2 b) => new(b.X + (b.X - a.X), b.Y + (b.Y - a.Y));
}