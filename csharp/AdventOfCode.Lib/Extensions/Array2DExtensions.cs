...
namespace AdventOfCode.Lib
{
    public static class Array2DExtensions
    {
        ...
        public static Rectangle Bounds<T>(this T[,] source) => new Rectangle(0, 0, source.GetLength(1), source.GetLength(0));
