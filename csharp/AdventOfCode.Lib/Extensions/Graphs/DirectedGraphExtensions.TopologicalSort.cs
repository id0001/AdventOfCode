...
namespace AdventOfCode.Lib
{
    public static partial class DirectedGraphExtensions
    {
        ...
        public static IEnumerable<TVertex> LexicographicalTopologicalSort<TVertex, TEdge>(this DirectedGraph<TVertex, TEdge> graph, IComparer<TVertex>? comparer = null)
            where TVertex : notnull, IComparable<TVertex>
            where TEdge : notnull
        {
            Requires.NotNull(graph, nameof(graph));
