...
namespace AdventOfCode.Lib
{
    ...
    {
        public static bool TryPath<TVertex>(this DirectedGraph<TVertex, int> graph, TVertex start, Func<TVertex, bool> isFinished, out IEnumerable<TVertex> path, out int totalCost)
        ...
        private static IEnumerable<TVertex> GetAdjacent<TVertex, TEdge>(DirectedGraph<TVertex, TEdge> graph, TVertex current)
            where TVertex : notnull
            where TEdge : notnull
        {
