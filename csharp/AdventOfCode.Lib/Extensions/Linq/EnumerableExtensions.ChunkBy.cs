...
public static partial class EnumerableExtensions
{
    ...
    public static async IAsyncEnumerable<IEnumerable<T>> ChunkBy<T>(this IAsyncEnumerable<T> source,
        Func<T, bool> predicate, bool matchIsLastItem = false)
    {
        var list = new List<T>();
