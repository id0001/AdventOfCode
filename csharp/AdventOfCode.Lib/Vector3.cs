namespace AdventOfCode.Lib
{
    public readonly record struct Vector3(double X, double Y, double Z)
    {
        ...
        public static Vector3 Multiply(Vector3 left, double scalar) => new(left.X * scalar, left.Y * scalar, left.Z * scalar);
        ...
        public bool Equals(Vector3 other) => X.MarginalEquals(other.X) && Y.MarginalEquals(other.Y) && Z.MarginalEquals(other.Z);
