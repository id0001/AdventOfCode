...
namespace AdventOfCode.Lib.Collections
{
        ...
        where TKey : notnull
    {
        ...
        public bool Contains(KeyValuePair<TKey, TValue?> item) => _dict.Contains(item.Key) && EqualityComparer<TValue?>.Default.Equals((TValue?)_dict[item.Key], item.Value);
        ...
        private class Enumerator : IEnumerator<KeyValuePair<TKey, TValue?>>
        {
            ...
            public Enumerator(IDictionaryEnumerator enumerator)
            {
            ...
            public bool MoveNext()
            {
                ...
                Current = new KeyValuePair<TKey, TValue?>((TKey)_enumerator.Key, (TValue?)_enumerator.Value);
                return true;
            }
